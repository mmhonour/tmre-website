...
/**
 * Single panel: Fed Target Range | Prevailing CPI on top;
 * Next FOMC | Next CPI below.
 */
export default function FedPolicySnapshot({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-charcoal/[0.08] bg-white shadow-sm shadow-charcoal/[0.04]">
      <div className="grid border-b border-charcoal/[0.08] bg-cream/30 lg:grid-cols-2 lg:divide-x lg:divide-charcoal/[0.08]">
