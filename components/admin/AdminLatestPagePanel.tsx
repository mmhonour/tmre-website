...
import { adminArchitectureHref } from "@/lib/admin-nav";
    ...
    >
      ...
      <div className="px-5 sm:px-6 py-4 space-y-4 text-sm text-slate">
        ...
        <div className="space-y-2 leading-relaxed">
          ...
          <ol className="list-decimal pl-5 space-y-1.5">
            ...
            <li>
              ...
              listings — event badges and ranking (Architecture → Status logic)
              are applied then.
            </li>
            <li>
        ...
        <p className="text-xs text-charcoal/50">
          Badge precedence and feed ranking:{" "}
          <Link
            href={adminArchitectureHref("status-logic")}
            className="text-navy underline-offset-2 hover:underline"
          >
            Architecture → Status logic
          </Link>
          .
        </p>
      </div>
