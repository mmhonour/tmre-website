...
export const ADMIN_NETLIFY_FUNCTIONS: AdminServerEntry[] = [
  ...
  },
  {
    ...
    detail:
      "Thin R2 photo scavenger trigger — enqueues hero-photos on the sync runner when Configure is due (default every 15m). Harvest order is Configure (newest listings default). Skip persists so leftovers still get filled. Idle when 100% complete. No Netlify worker.",
