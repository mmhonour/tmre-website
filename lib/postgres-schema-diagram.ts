...
const DOCUMENTED_POSTGRES_RELATIONSHIPS: SqliteRelationship[] = [
  ...
  {
    from: { table: 'listings', column: 'id' },
    to: { table: 'listing_location_estimates', column: 'listing_id' },
    source: 'documented',
  },
  {
    from: { table: 'listings', column: 'id' },
    to: { table: 'listing_location_estimate_snapshots', column: 'listing_id' },
    source: 'documented',
  },
  {
    from: { table: 'listings', column: 'id' },
...
const DOCUMENTED_POSTGRES_COLUMNS: Record<string, SqliteColumnInfo[]> = {
  ...
  listing_location_estimates: [
    ...
    { name: 'kind', type: 'text', notNull: false, primaryKey: false, defaultValue: null },
    { name: 'sold_count', type: 'integer', notNull: true, primaryKey: false, defaultValue: '0' },
    { name: 'sold_median_ppsf', type: 'numeric', notNull: false, primaryKey: false, defaultValue: null },
    ...
    { name: 'sold_premium_pct', type: 'numeric', notNull: false, primaryKey: false, defaultValue: null },
    { name: 'listing_premium_pct', type: 'numeric', notNull: false, primaryKey: false, defaultValue: null },
    { name: 'explains_location', type: 'boolean', notNull: true, primaryKey: false, defaultValue: 'false' },
