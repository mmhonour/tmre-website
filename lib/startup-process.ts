      ...
      steps: [
        {
          ...
          timing: "weekly",
          detail:
            "rebuildAllListingEdgeScores(): zip benchmarks, layout, condition (remarks + cached finish-quality) into listing_edge_scores. Netlify */30 cron + listing-scores Configure cadence, gated on last_listing_edge_scores (not Goldilocks End). Skips when Pause is checked on Goldilocks / listing-scores.",
