...
function mapListing(r: RawRetsRecord): Listing {
  ...
  return {
    ...
    dom: num(r.DOM),
    listDate: normalizeMlsDate(str(r.ListingContractDate)),
    modificationTimestamp: normalizeMlsTimestamp(str(r.ModificationTimestamp)),
    priceChangeTimestamp: normalizeMlsTimestamp(str(r.PriceChangeTimestamp)),
    statusChangeTimestamp: normalizeMlsTimestamp(str(r.StatusChangeTimestamp)),
