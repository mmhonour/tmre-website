    ...
    ownership: [
      {
        ...
        doesNot:
          'Deal board, latest town feeds, the rest of the showcase six, stats_cache rebuild, spotlight refresh, or sending alert email. Mail is the Railway alerts job. First-six photo bytes for new Incremental inserts are still Site warm. Walking remaining photos for every listing (Active or not) is the R2 photo scavenger (queue job_id hero-photos, own forked child, lowest claim rank).',
      },
      {
        id: 'lane-2',
