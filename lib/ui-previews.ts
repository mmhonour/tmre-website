...
export const UI_PREVIEWS: readonly UiPreviewEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Next open-house gold mark on grid (photo upper right), rows (panel upper right), and compact (right-aligned). Rows photo stretches to the row height. Listing alerts reuse Intelligence searches, or town + home type + price.",
  },
  {
