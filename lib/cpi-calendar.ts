...
/** Forward schedule (2025+) — concatenated with {@link CPI_HISTORY}. */
const CPI_FORWARD: readonly CpiRelease[] = [
  // —— 2025 —— (YoY from BLS CUUR0000SA0)
  {
    id: '2025-01',
  ...
  },
  {
    ...
    coreYoyPct: null,
    releaseUrl: 'https://www.bls.gov/news.release/cpi.nr0.htm',
    note: 'October 2025 print skipped (BLS lapse in appropriations).',
  },
  {
    id: '2025-12',
