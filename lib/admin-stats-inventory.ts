...
export const STATS_INVENTORY: StatsInventoryEntry[] = [
  ...
  },
  {
    ...
    medium: 'postgres',
    location: 'stats_cache',
    keyPattern: 'latest-town-feed:v2:{town|bundle}',
  ...
  // —— Deals ——
  {
    ...
    medium: 'postgres',
    location: 'stats_cache',
    keyPattern: 'deal-of-the-day:v8:{town}:{kind}:{propertyClass}',
    owner: 'lib/deal-of-the-day-cache.ts',
    notes:
      '7 towns × sale/rental × homes/multi/condos = 42. Below-median uses market-stats.medianPrice12Mo (trailing 12-month closed). Preserved across hourly stats_cache clears.',
