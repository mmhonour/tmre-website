...
export function defaultSyncScheduleConfig(): SyncScheduleConfig {
  return {
    ...
    jobs: {
      ...
      // Open houses are announced and cancelled through the week. The job
      // inventories today through today+6; the page shows this week
      // (Sunday 12:00 AM ET resets to Sunday–Saturday). A year of history
