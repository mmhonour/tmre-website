...
export function statsMonthsSupplyByMonthTownTitle(kind: StatsKind): string {
  return kind === 'rental'
    ? 'Months supply · rentals · by town'
    : 'Months supply · by town'
}
...
export function statsListToAskTitle(kind: StatsKind): string {
  return kind === 'rental'
    ? `${LIST_TO_TRANSACT_LABEL} · rentals · by town`
    : `${LIST_TO_TRANSACT_LABEL} · by town`
}
