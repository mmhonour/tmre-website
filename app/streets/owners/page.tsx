      ...
      <section className="navy-gradient text-white pt-20 pb-8 lg:pt-24 lg:pb-10 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <p className="mt-3 max-w-xl font-mono text-sm text-white/70">
            ...
            An owner cluster is the same mailbox. Each panel is an
            invisible grid: address left, last paid date and amount
            right-aligned. Date and Amount sort those purchases by clock
            and dollars, not the printed string. Purchase total at the
            bottom of the panel.
            {streetName
