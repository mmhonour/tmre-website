...
function townSlug(town: TmreTown): string {
...
function fixtureDeal(town: TmreTown): DealCarouselPayload {
  ...
  return {
    ...
    photoUrl: `/dod-preview/bleeds/${slug}.jpg`,
    listing: {
      mlsId: `preview-dod-${slug}`,
      status: "Active",
...
export function dodTownBleedFixtureDeals(): DealCarouselDealsByTown {
...
export const dodBleedShowcaseFixtureDeals = dodTownBleedFixtureDeals;
