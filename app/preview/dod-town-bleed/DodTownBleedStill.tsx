...
export function DodTownBleedStill({
  ...
  return (
    <article className="relative overflow-hidden rounded-2xl navy-gradient shadow-[0_18px_40px_-24px_rgba(13,20,36,0.55)]">
      <div className="relative min-h-[220px]">
        ...
        <div className="relative z-[1] space-y-2 px-5 py-5">
          ...
          {address ? (
            <p className="font-mono text-[11px] text-white/60">{address}</p>
          ) : (
