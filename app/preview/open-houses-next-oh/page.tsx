    ...
    <div className="min-h-screen bg-cream">
      <div className="mx-auto max-w-6xl px-4 pb-12 pt-28 sm:px-6">
        ...
        <p className="mb-8 text-sm leading-relaxed text-slate">
          Gold next-OH mark: grid upper-right on the photo, rows upper-right
          of the text panel (not the hero), compact right-aligned. Rows hero
          stretches to the row height. Alerts use
