      ...
      <div className="hidden min-h-screen bg-cream lg:block">
        <div className="mx-auto max-w-lg px-4 pb-8 pt-28 sm:px-6">
          ...
          <p className="mb-3 text-sm leading-relaxed text-slate">
            ...
            Tap empty photo (not the town name or headline) to open that
            listing’s showcase. Pause · town · For Sale is directly under
            the bleed, insight under the carousel, value-pick with no photo
            and no second carousel. The next-town arrow stays put for the
            widest town name. {sourceLine} On a phone this URL is
            full-bleed under the live header.
          </p>
